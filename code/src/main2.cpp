...
glm::vec4 camposition = glm::vec4(40.0, -40.0, 40.0, 1.0);
GLint vCam_uniform;
...
void createBoundingbox(unsigned int &program, unsigned int &vao)
{
    ...
    // GLint min_x, min_y, max_x, max_y, min_z, max_z;

    glBindBuffer(GL_ARRAY_BUFFER, vertex_vbo);
    glEnableVertexAttribArray(vVertex_attrib);
    glVertexAttribPointer(vVertex_attrib, 4, GL_FLOAT, GL_FALSE, 0, 0);
